...
export const searchUserRequest = employeeName => ({ type: SEARCH_USER_REQUEST, payload: employeeName });
export const searchUserSuccess = users => ({ type: SEARCH_USER_SUCCESS, payload: users });
export const searchUserFailure = error => ({ type: SEARCH_USER_FAILURE, payload: error });